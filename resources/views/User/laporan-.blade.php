...
{{-- @section('title', 'QnA - Dexza Pengaduan')

@section('header', 'Dashboard Laporan') --}}
        ...
        <div class="container">
            <div class="container-fluid"> --}}
                {{-- <a class="navbar-brand" href="{{ route('pekat.index') }}">
                    <h4 class="semi-bold mb-0 text-white">QnA</h4>
                    <p class="italic mt-0 text-white">Pengaduan Client</p>
                </a>
...
<div class="container">
            ...
            <div class="content content-top shadow">
                ...
                <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('nama_proyek') }}" name="nama_proyek" placeholder="Masukkan Nama Proyek"
                            class="form-control">
                    </div>
                    <div class="form-group">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #6a70fc" href="#">{{ Auth::guard('client')->user()->nama }}</a></h5>
                        <p class="text-dark">{{ Auth::guard('client')->user()->username }}</p>
                    </div>
    ...
    <table id="pengaduanTable" class="table">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $k += 1 }}</td>
                <td>{{ $v->tgl_pengaduan->format('h:i , d M') }}</td>
                <td>  {{ $v->nama_proyek }}</td>
                <td>{{ $v->isi_laporan }}</td>
                <td>
                    @if ($v->status == '0')
                ...
                <td>
                    <form action="{{ route('pekat.laporan') }}" method="POST">
                        @csrf
                        @method('DELETE')
